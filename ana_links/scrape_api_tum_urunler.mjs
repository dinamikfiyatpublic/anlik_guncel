...
async function scrapePage(page, timestamp) {
    const url = `https://api.scrapingant.com/v2/general?url=https://api6.akakce.com/core/v2/category/ctquery?ctCode=${ctcode}&page=1&Sort=1&x-api-key=${scrpant}&browser=false`; 
    try {
